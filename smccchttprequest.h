#ifndef SMCCCHTTPREQUEST_H
#define SMCCCHTTPREQUEST_H
...
class SMCCCHttpRequest : public QObject
{
    Q_OBJECT
public:
    explicit SMCCCHttpRequest(QObject *parent = 0);
    //同步数据传输，可能会出现阻塞现象
