...
bool Json_InheritsFrom::process(){
    QString inheritsFromFilePath = Json::_VersionDirPath + "\\" + Json::_inheritsFrom + "\\" + Json::_inheritsFrom + ".json";
    if (!Launcher::isFileExist(inheritsFromFilePath))return false;
